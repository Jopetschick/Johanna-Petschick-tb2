...
# Creating a frame (f1) to contain image label
f1 = tk.Frame(root)
# Opening image file from the 'images' folder
...
def expiration_checker():
    ...
    # Create and pack widgets
    label_food_group = tk.Label(root, text='Select Food Group:', font='Quicksand 12 bold',
                                bg='#D4A9D4', bd='0', fg='white')
    ...
    label_food_item = tk.Label(root, text='Select Food Item:', font='Quicksand 12 bold',
                               bg='#D4A9D4', bd='0', fg='white')
...
def veggie_page():
    ...
    recipe_card2 = tk.Button(root, text='Recipe Card: Cauliflower Zing', font='Quicksand 9 bold',
                             bg='#D4A9D4', bd='0', fg='#D695CF', width=18, command=recipe_cauliflower)
    recipe_card2.place(x=10, y=257)

    recipe_card3 = tk.Button(root, text='Recipe Card: Zucchini Fries', font='Quicksand 9 bold',
                             bg='#D4A9D4', bd='0', fg='#D695CF', width=17, command=recipe_zucchini)
